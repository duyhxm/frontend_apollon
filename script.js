...
window.addEventListener('DOMContentLoaded', () => {
    ...
    function changeLanguage(e) {
        if (e.id === 'chinese') {
            console.log(`language is chinese`);
            window.location.href = 'https://www.duyhxm.me/cn/index.html';
        } else if (e.id === 'vietnamese') {
            window.location.href = 'https://www.duyhxm.me/vi/index.html';
            console.log(`language is vietnamese`);
        } else if (e.id === 'english') {
            window.location.href = 'https://www.duyhxm.me/index.html';
            console.log(`language is english`);
        }
    }
});
